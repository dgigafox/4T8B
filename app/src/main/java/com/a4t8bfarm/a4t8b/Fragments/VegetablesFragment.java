 ...
 */
public class VegetablesFragment extends Fragment implements AsyncResponse, AdapterView.OnItemClickListener {

    SessionManagement session;
    SQLiteDBHelper sqLiteDBHelper;

    final String LOG = "VegetablesFragment";

    final static String url = "https://androidshopping.000webhostapp.com/product_vegetables.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null){
            productList = (ArrayList<Products>) savedInstanceState.getSerializable("productList");
        }

        ImageLoader.getInstance().init(UILConfig.config(VegetablesFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(VegetablesFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnAddToCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, final int position, View view) {
                ...
                AlertDialog.Builder selectUnitDialog= new AlertDialog.Builder(VegetablesFragment.this.getActivity());
                    ...
                    public void onClick(DialogInterface dialog, final int whichbutton) {
                        ...
                        switch (selectedUnit) {
                            ...
                            case "kilo":
                                ...
                                AlertDialog.Builder selectWeightDialog = new AlertDialog.Builder(VegetablesFragment.this.getActivity());
        ...
        adapter = new FunDapter<>(VegetablesFragment.this.getActivity(), productList, R.layout.produce_product_row, dic);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(VegetablesFragment.this.getActivity(), ProductDetailActivity.class);
    ...
    private class WriteToDB extends AsyncTask<Void, Void, Void>{
        ...
        String selectedUnit;
        Double price;
        ProgressDialog progressDialog = new ProgressDialog(VegetablesFragment.this.getActivity());
        ...
        protected Void doInBackground(Void... params){
            sqLiteDBHelper = new SQLiteDBHelper(VegetablesFragment.this.getActivity());
        ...
        protected void onPostExecute(final Void unused) {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    Toast.makeText(VegetablesFragment.this.getActivity(), "Added to Cart: "+selectedItem.name, Toast.LENGTH_SHORT).show();
                }
    ...
    private void openSelectQtyDialog(String title, String selectedUnit, final Qty qty){
        LinearLayout linearLayout = new LinearLayout(VegetablesFragment.this.getActivity());
        linearLayout.setOrientation(linearLayout.VERTICAL);
        linearLayout.setGravity(Gravity.CENTER_HORIZONTAL);
        final EditText input = new EditText(VegetablesFragment.this.getActivity());
        ...
        final AlertDialog.Builder selectQtyDialog = new AlertDialog.Builder(VegetablesFragment.this.getActivity());
                ...
                if(!qtyString.equals("")){
                    ...
                    if(qtyDouble > 0.0 && qtyDouble <= 99.0){
                        if(qtyDouble%0.25 == 0.0){
                            ...
                            Animation shake = AnimationUtils.loadAnimation(VegetablesFragment.this.getActivity(), R.anim.shake);
                            input.startAnimation(shake);
                            Toast.makeText(VegetablesFragment.this.getActivity(),"Please enter a valid quantity for kilo.",Toast.LENGTH_SHORT).show();
                        }
                    }
                        ...
                        Animation shake = AnimationUtils.loadAnimation(VegetablesFragment.this.getActivity(), R.anim.shake);
                        input.startAnimation(shake);
                        Toast.makeText(VegetablesFragment.this.getActivity(),"Please enter values from 1 to 99 only.",Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    qty.returnQty(qtyDouble);
    ...
    private void addToCart(HashMap<String, String> postData, Products selectedItem){
        ...
        if (session.isLoggedIn()) {
            PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                    VegetablesFragment.this.getActivity(), postData, new AsyncResponse() {
                @Override
                public void processFinish(String s) {
                    Log.d(LOG, s);
                    if (s.contains("success")) {
                        Toast.makeText(VegetablesFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                    } else if (s.contains("limit reached")) {
                        Toast.makeText(VegetablesFragment.this.getActivity(), "We limit orders to 99 per item only.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
